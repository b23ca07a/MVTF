...
if __name__ == '__main__':
    ...
    visualfeat_net = VisualFeatNet(pretrain=os.path.join(path, 'pretrained/frcnn_128_512.backbone.pth.tar'))
    fake_lip = torch.rand(1, 1, 100, 88, 88)
    mouth_emb = visualfeat_net(fake_lip)
    print(mouth_emb.shape)